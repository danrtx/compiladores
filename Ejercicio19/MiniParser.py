...
class MiniParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "IGUAL", "PRINT", "MAS", "ID", "NUM", 
                      "WS" ]
    ...
    class StatContext(ParserRuleContext):
        ...
        def IGUAL(self):
            return self.getToken(MiniParser.IGUAL, 0)
        ...
        def PRINT(self):
            return self.getToken(MiniParser.PRINT, 0)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def MAS(self):
            return self.getToken(MiniParser.MAS, 0)
