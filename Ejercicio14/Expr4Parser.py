...
class Expr4Parser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "MAS", "MENOS", "MUL", "DIV", "LPAREN", 
                      "RPAREN", "NUM", "WS" ]
    ...
    class ExprContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Expr4Parser.TermContext)
            else:
                return self.getTypedRuleContext(Expr4Parser.TermContext,i)


        def MAS(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.MAS)
            else:
                return self.getToken(Expr4Parser.MAS, i)

        def MENOS(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.MENOS)
            else:
                return self.getToken(Expr4Parser.MENOS, i)
    ...
    def expr(self):
        ...
        localctx = Expr4Parser.ExprContext(self, self._ctx, self.state)
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(Expr4Parser.FactorContext)
            else:
                return self.getTypedRuleContext(Expr4Parser.FactorContext,i)


        def MUL(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.MUL)
            else:
                return self.getToken(Expr4Parser.MUL, i)

        def DIV(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.DIV)
            else:
                return self.getToken(Expr4Parser.DIV, i)
    ...
    class FactorContext(ParserRuleContext):
        ...
        def LPAREN(self):
            return self.getToken(Expr4Parser.LPAREN, 0)
        ...
        def RPAREN(self):
            return self.getToken(Expr4Parser.RPAREN, 0)

        def getRuleIndex(self):
            return Expr4Parser.RULE_factor
    ...
    def factor(self):
        ...
        localctx = Expr4Parser.FactorContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [7]:
                ...
                self.state = 23
                self.match(Expr4Parser.LPAREN)
                self.state = 24
                self.expr()
                self.state = 25
                self.match(Expr4Parser.RPAREN)
                pass
            else:
