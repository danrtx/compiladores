...
def serializedATN():
    return [
        ...
        0,19,48,1,0,0,0,21,53,1,0,0,0,23,24,5,40,0,0,24,2,1,0,0,0,25,26,
        5,41,0,0,26,4,1,0,0,0,27,28,5,42,0,0,28,6,1,0,0,0,29,30,5,47,0,0,
        30,8,1,0,0,0,31,32,5,43,0,0,32,10,1,0,0,0,33,34,5,45,0,0,34,12,1,
        0,0,0,35,36,5,61,0,0,36,14,1,0,0,0,37,39,7,0,0,0,38,37,1,0,0,0,39,
...
class CalculadoraLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "MUL", "DIV", "ADD", "SUB", "EQ", "ID", "INT", "NEWLINE", "WS" ]

    ruleNames = [ "T__0", "T__1", "MUL", "DIV", "ADD", "SUB", "EQ", "ID", 
                  "INT", "NEWLINE", "WS" ]
