...
class CalcParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "IGUAL", "PRINT", "MAS", "MENOS", "MUL", 
                      "DIV", "LPAREN", "RPAREN", "ID", "NUM", "WS" ]
    ...
    class StatContext(ParserRuleContext):
        ...
        def IGUAL(self):
            return self.getToken(CalcParser.IGUAL, 0)
        ...
        def PRINT(self):
            return self.getToken(CalcParser.PRINT, 0)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def MAS(self, i:int=None):
            if i is None:
                return self.getTokens(CalcParser.MAS)
            else:
                return self.getToken(CalcParser.MAS, i)

        def MENOS(self, i:int=None):
            if i is None:
                return self.getTokens(CalcParser.MENOS)
            else:
                return self.getToken(CalcParser.MENOS, i)
