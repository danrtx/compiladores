...
def serializedATN():
    return [
        ...
        1,0,0,0,5,15,1,0,0,0,7,17,1,0,0,0,9,20,1,0,0,0,11,12,5,43,0,0,12,
        2,1,0,0,0,13,14,5,45,0,0,14,4,1,0,0,0,15,16,5,42,0,0,16,6,1,0,0,
        0,17,18,5,47,0,0,18,8,1,0,0,0,19,21,7,0,0,0,20,19,1,0,0,0,21,22,
        1,0,0,0,22,20,1,0,0,0,22,23,1,0,0,0,23,24,1,0,0,0,24,25,6,4,0,0,
        25,10,1,0,0,0,2,0,22,1,6,0,0
    ]

class OperadoresLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "MAS", "MENOS", "MUL", "DIV", "WS" ]

    ruleNames = [ "MAS", "MENOS", "MUL", "DIV", "WS" ]
