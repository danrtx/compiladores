...
class Expr3Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Expr3Parser#factor.
    def enterFactor(self, ctx:Expr3Parser.FactorContext):
        pass

    # Exit a parse tree produced by Expr3Parser#factor.
    def exitFactor(self, ctx:Expr3Parser.FactorContext):
        pass
